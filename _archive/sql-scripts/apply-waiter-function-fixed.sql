-- Apply the create_waiter_user function to your database
-- Run this in Supabase SQL Editor

-- First check if pgcrypto extension is enabled (needed for password hashing)
CREATE EXTENSION IF NOT EXISTS pgcrypto;

-- Create the function with proper delimiter
...
AND routine_name = 'create_waiter_user';
