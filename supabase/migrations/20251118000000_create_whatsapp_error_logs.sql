...
-- Create index for faster queries
CREATE INDEX IF NOT EXISTS idx_whatsapp_alerts_created_at ON whatsapp_alerts(created_at DESC);
CREATE INDEX IF NOT EXISTS idx_whatsapp_alerts_category ON whatsapp_alerts(category);
