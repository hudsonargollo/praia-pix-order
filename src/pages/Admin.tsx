    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-blue-50 to-indigo-100">
      ...
      <div className="p-4 sm:p-6 lg:p-8">
        <div className="max-w-7xl mx-auto">
          {/* Responsive Grid - 2x2 on all screen sizes */}
          <div className="grid grid-cols-2 gap-3 sm:gap-6 max-w-4xl mx-auto">
            {adminMenuItems.map((item) => (
              ...
              >
                <CardContent className="p-4 sm:p-8 text-center relative h-full flex flex-col justify-center items-center">
                  {/* Background Pattern */}
                  ...
                  <div className="relative mb-3 sm:mb-6">
                    <div className="w-12 h-12 sm:w-20 sm:h-20 mx-auto bg-gradient-to-br from-purple-600 via-purple-700 to-blue-600 rounded-xl sm:rounded-2xl flex items-center justify-center shadow-xl group-hover:shadow-2xl group-hover:scale-110 transition-all duration-300">
                  ...
                  {/* Content */}
                  <div className="relative">
                    <h3 className="font-bold text-sm sm:text-xl text-gray-900 mb-1 sm:mb-3 group-hover:text-purple-700 transition-colors">
                      {item.title}
                    </h3>
                    <p className="text-xs sm:text-sm text-gray-600 group-hover:text-gray-700 transition-colors hidden sm:block">
                      {item.description}
                    </p>
                  </div>
