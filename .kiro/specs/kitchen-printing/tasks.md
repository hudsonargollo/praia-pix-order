...
- [x] 2. Create OrderReceipt print component
...
- [x] 3. Create ReportPrintView component
...
- [x] 4. Implement usePrintOrder hook for manual printing
...
- [x] 5. Implement useAutoPrint hook for automatic printing
...
- [x] 6. Create AutoPrintToggle component
...
- [x] 7. Integrate auto-print into Kitchen page
...
- [x] 8. Add manual print button to OrderCardInfo component
...
- [x] 9. Add manual print button to CompactOrderCard component
  - Update `src/components/CompactOrderCard.tsx` to add print button in action buttons section
  - Integrate usePrintOrder hook
  - Render hidden OrderReceipt component for printing
  - _Requirements: 2.1, 2.2_

- [x] 10. Implement usePrintReport hook
...
- [x] 11. Integrate report printing into Reports page
...
- [x] 12. Add print styles to global CSS
